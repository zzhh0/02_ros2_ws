...
class PoseMonitor : public rclcpp::Node
{
    ...
    PoseMonitor():Node("pose_monitor")
    {
        ...
        mMyPoseSub = this->create_subscription<robot_interfaces::msg::RobotPose>("/my_robot_pose",10,std::bind(
    ...
    private:
        ...
        void myPoseCallBack(const robot_interfaces::msg::RobotPose::SharedPtr msg) const
        {
        ...
        rclcpp::Subscription<robot_interfaces::msg::RobotPose>::SharedPtr mMyPoseSub;
};
